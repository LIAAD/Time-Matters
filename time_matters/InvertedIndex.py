...
def kw_ext(lang, text,max_keywords,  heideltime_document_type, heideltime_document_creation_time):
    ...
    dates, new_text = candidate_years(text, lang, heideltime_document_type, heideltime_document_creation_time)
...
def candidate_years(text, language, heideltime_document_type, heideltime_document_creation_time):
    years = []
    list_dates = heideltime(text, language, heideltime_document_type, heideltime_document_creation_time)
    new_text = text
