...
def Dates(text, date_per_sentence, context_window_distance, threshold, max_array_len, max_keywords, ignore_contextual_window_distance, analysis_sentence, input_file, heideltime_document_type, heideltime_document_creation_time):
    def run_time_matters(text_content):
        if date_per_sentence:
            output = timeMattersPerSentence(text_content, context_window_distance, threshold, max_array_len, max_keywords, ignore_contextual_window_distance, heideltime_document_type, heideltime_document_creation_time)
            print(output)
        else:
            output = timeMatters(text_content, context_window_distance, threshold, max_array_len, max_keywords, analysis_sentence, ignore_contextual_window_distance, heideltime_document_type, heideltime_document_creation_time)
            print(output)
