...
def verify_temporal_tagger(tt_name, language, document_type, date_granularity, document_creation_time, begin_date, end_date):
...
def verify_time_matters_input(time_matters):
    n_gram = 1
    num_of_keywords = 10
