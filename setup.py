...
setup(name='time_matters',
      ...
      install_requires=["yake==0.4.1", "py_heudeltime"],
      dependency_links=['https://github.com/LIAAD/yake.git#egg=yake-0.4.1','https://github.com/JMendes1995/py_heideltime.git#egg=pakage']
)
